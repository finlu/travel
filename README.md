...
2. better-scroll：https://github.com/ustbhuangyi/better-scroll
...
在webpack中仿照 `@` 代表`src` 目录的方式，给指定的文件夹起别名，之后在import语句中就可以使用别名进行引入。

在`css`中`import` 变量的时候，需要在路径前加上`~`
